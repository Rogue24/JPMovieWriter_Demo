...
//        }()
    ...
    var valueDidChangedForUser: ((CGFloat) -> ())?
    ...
    var isNeedShowValue = false
    
    private var isShowValue = false {
        didSet {
            guard isNeedShowValue else { return }
...
//        lastValue = slider.value
    ...
    @objc func sliderChanged() {
        isShowValue = true
        valueDidChangedForUser?(value)
        // 貌似使用了麦克风就不会有震动反馈，暂时无解
